...
2. Load Libraries\
3. Import and Manipulate Data\
4. Plot the Map\
5. Descriptive Statistics\
6. Save the Output to the Geodatabase
...
# place for accessing data
data_week4 <- "D:/0. Master/Data/giss/week4"
...
world_gii <- read_csv("D:/0. Master/Data/giss/week4/HDR21-22_Composite_indices_complete_time_series.csv") %>%
  ...
  dplyr::mutate(delta_gii = gii_2019 - gii_2010)

#import world map
world_map <- st_read("D:/0. Master/Data/giss/week4/World_Countries_Generalized.gdb") %>%
...
histogram_gii <- plot_ly(world_map) %>%
